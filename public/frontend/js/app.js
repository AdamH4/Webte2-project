...
var Landing = /*#__PURE__*/function () {
  ...
  _createClass(Landing, [{
    key: "initHideTabImages",
    value: function initHideTabImages() {
    ...
    value: function bindEvents() {
      ...
      this.studentTab.addEventListener("click", function (e) {
        ...
        setTimeout(function () {
          if (_this.studentTab.classList.contains("active")) {
            _this.studentIconHover.style.display = "inline-block";
            _this.studentIcon.style.display = "none";
            _this.teacherIconHover.style.display = "none";
            _this.teacherIcon.style.display = "inline-block";
          } else {
            _this.studentIconHover.style.display = "none";
            _this.studentIcon.style.display = "inline-block";
            _this.teacherIconHover.style.display = "inline-block";
            _this.teacherIcon.style.display = "none";
          }
        }, 1);
      });
      this.teacherTab.addEventListener("click", function (e) {
        setTimeout(function () {
          if (_this.teacherTab.classList.contains("active")) {
            _this.teacherIconHover.style.display = "inline-block";
            _this.teacherIcon.style.display = "none";
            _this.studentIconHover.style.display = "none";
            _this.studentIcon.style.display = "inline-block";
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Landing__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Landing */ "./resources/js/Landing.js");
